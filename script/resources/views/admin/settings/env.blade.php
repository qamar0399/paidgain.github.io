                    ...
                    <div class="col-12 col-sm-12 col-md-4">
                        <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#social" role="tab" aria-controls="Social" aria-selected="false">{{ __('Social Login (Google Facebook)') }}</a>
                            </li>
                    ...
                    <div class="col-12 col-sm-12 col-md-8">
                        ...
                        <div class="tab-content no-padding" id="myTab2Content">
                            <div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                ...
                                <div class="form-group">
                                    <label>{{ __('DISCUSS_COMMENT_KEY') }}</label>
                                    <input type="text" name="DISCUSS_COMMENT_KEY" class="form-control" value="{{ env('DISCUSS_COMMENT_KEY') }}">
                                    
                                </div>
                                <div class="form-group">
                                    <label>{{ __('AUTO_EMAIL_VERIFICATION') }}</label>
                                    <select class="form-control" name="AUTO_EMAIL_VERIFICATION">
                                        <option value="true" @if(env('AUTO_EMAIL_VERIFICATION') == true) selected @endif>true</option>
                                        <option value="false" @if(env('AUTO_EMAIL_VERIFICATION') == false) selected @endif>false</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('AUTO_PHONE_VERIFICATION') }}</label>
                                    <select class="form-control" name="AUTO_PHONE_VERIFICATION">
                                        <option value="true" @if(env('AUTO_PHONE_VERIFICATION') == true) selected @endif>true</option>
                                        <option value="false" @if(env('AUTO_PHONE_VERIFICATION') == false) selected @endif>false</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('WITHDRAW_PREFIX') }}</label>
                                    <input type="text" name="WITHDRAW_PREFIX" class="form-control" value="{{ env('WITHDRAW_PREFIX') }}">
                            ...
                            <div class="tab-pane fade" id="social" role="tabpanel" aria-labelledby="profile-tab4">
                                <div class="form-group">
                                    <label>{{ __('GOOGLE_CLIENT_ID') }}</label>
                                    <input type="text"  name="GOOGLE_CLIENT_ID" class="form-control" value="{{ env('GOOGLE_CLIENT_ID') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('GOOGLE_CLIENT_SECRET') }}</label>
                                    <input type="text"  name="GOOGLE_CLIENT_SECRET" class="form-control" value="{{ env('GOOGLE_CLIENT_SECRET') }}">
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label>{{ __('FACEBOOK_CLIENT_ID') }}</label>
                                    <input type="text"  name="FACEBOOK_CLIENT_ID" class="form-control" value="{{ env('FACEBOOK_CLIENT_ID') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('FACEBOOK_CLIENT_SECRET') }}</label>
                                    <input type="text"  name="FACEBOOK_CLIENT_SECRET" class="form-control" value="{{ env('FACEBOOK_CLIENT_SECRET') }}">
                                </div>
                            </div>                            
                            ...
                            <div class="tab-pane fade" id="mail_configuration" role="tabpanel" aria-labelledby="profile-tab4">
                                <div class="form-group">
                                    ...
                                    <select name="QUEUE_MAIL" class="form-control">
                                        <option value="true" @if(env('QUEUE_MAIL') == true) selected="" @endif>{{ __('On') }}</option>
                                        <option value="false" @if(env('QUEUE_MAIL') == false) selected="" @endif>{{ __('Off') }}</option>
                                    </select>
                                </div>
                                @php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"   name="MAIL_TO_ADDRESS" class="form-control" value="{{ env('MAIL_TO_ADDRESS') }}">
                                </div>
