...
@section('head')
    @include('layouts.backend.partials.headersection',['title'=>'Add New Role','prev'=> route('admin.role.index')])
@endsection
...
<div class="row">
	<div class="col-lg-9">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="{{ route('admin.role.store') }}" class="ajaxform_with_reload">
					@csrf
					<div class="pt-20">
