         ...
         <div class="tab-content" id="myTabContent2">
            ...
            <div class="tab-pane fade" id="media_list" role="tabpanel" aria-labelledby="profile-tab3">
               <div class="row">
                  ...
                  <div class="col-sm-2">
                     <div class="model-right-bar media-info-bar">
                        <img class="img-fluid media-thumbnail" id="previewimg" src="{{ asset('admin/img/img/placeholder.png') }}" alt="" height="200">
                        <div class="modal-media-info">

                           <div class="form-group">
                               <label for="medialink">{{ __('Full URL') }}:</label>
                              <input type="url" id="medialink" value="" class="form-control">
                           </div>
